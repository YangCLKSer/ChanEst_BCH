...
static void mld2sfbc(const creal_T Received[240], const creal_T mimoCH[960],
                     double Detected[240], double ampd[240]);
static void mld4sfbcfstd(const creal_T Received[240], const creal_T mimoCH[960],
  double Detected[240], double ampd[240]);
                     ...
                     double Detected[240], double ampd[240])
{
  ...
  for (idxStrm = 0; idxStrm < 120; idxStrm++) {
    ...
    Detected[Detected_tmp + 1] = (-tmpCH[1].re * Received[i1].re - -tmpCH[1].im *
      ...
      Received[i].im);
    ampd[i1] = b_norm(*(creal_T (*)[4])&tmpCH[0]);
    ampd[i] = b_norm(*(creal_T (*)[4])&tmpCH[4]);
  }
 ...
 * Return Type  : void
 */
void MIMO_detectRB(const creal_T RxData[240], const creal_T equCH[960], double
                   methodDetect, creal_T Detected_RB[240], double ampd[240])
{
  ...
  switch ((int)methodDetect) {
   ...
   default:
    ...
    /*      case 3 */
    /*          [Detected_RB ampd] = zf_nulling( RxData, equCH ); */
    /*      case 4 */
    /*          [Detected_RB ampd] = mmse_nulling( RxData, equCH ); */
    /*      case 5 */
    /*          [Detected_RB ampd] = zf_osic( RxData, equCH, mod_mode(1) ); */
    /*      case 6 */
    /*          [Detected_RB ampd] = mmse_osic( RxData, equCH, mod_mode(1) ); */
    /*      otherwise */
    /*          disp('Wrong detection mode for MIMO_receive.m!') */
    /*  		keyboard */
    break;
  }
}
...
/*
 * File trailer for MIMO_detectRB.c
 *
 * [EOF]
 */
