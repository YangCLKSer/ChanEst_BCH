...
static void ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, creal_T ret[960]);
...
static void m_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, char_T y_data[], int32_T y_size[2]);
static void n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *sym, const
  char_T *identifier, creal_T y[240]);
static void o_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, creal_T y[240]);
static void p_emlrt_marshallIn(const emlrtStack *sp, const mxArray *chanEst,
  const char_T *identifier, creal_T y[960]);
static void q_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, creal_T y[960]);
...
static void y_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, creal_T ret[240]);
...
static void ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, creal_T ret[960])
{
  static const int32_T dims[3] = { 1, 4, 240 };
  ...
  [480])
{
  const mxArray *y;
  const mxArray *m;
  static const int32_T iv[2] = { 1, 480 };
  ...
  [240])
{
  const mxArray *y;
  const mxArray *m;
  static const int32_T iv[2] = { 1, 240 };
  ...
  char_T *identifier, creal_T y[240])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  o_emlrt_marshallIn(sp, emlrtAlias(sym), &thisId, y);
  emlrtDestroyArray(&sym);
}
  ...
  const char_T *identifier, creal_T y[960])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  q_emlrt_marshallIn(sp, emlrtAlias(chanEst), &thisId, y);
  emlrtDestroyArray(&chanEst);
}
 ...
 * Return Type  : void
 */
void PBCH_Decode_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                     plhs[5])
{
  real_T (*trblk)[24];
  creal_T sym[240];
  ...
  st.tls = emlrtRootTLSGlobal;
  trblk = (real_T (*)[24])mxMalloc(sizeof(real_T [24]));

  /* Marshall function inputs */
  n_emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "sym", sym);
  p_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "chanEst", chanEst);
  emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "enb", &enb);

  /* Invoke the target function */
  PBCH_Decode(sym, chanEst, &enb, bits, symbols, &nfmod4, *trblk, &cellrefp);

  /* Marshall function outputs */
  plhs[0] = c_emlrt_marshallOut(&st, bits);
  if (nlhs > 1) {
    plhs[1] = d_emlrt_marshallOut(&st, symbols);
  }

  if (nlhs > 2) {
    plhs[2] = e_emlrt_marshallOut(nfmod4);
  }

  if (nlhs > 3) {
    plhs[3] = f_emlrt_marshallOut(*trblk);
  }

  if (nlhs > 4) {
    plhs[4] = e_emlrt_marshallOut(cellrefp);
  }
}
