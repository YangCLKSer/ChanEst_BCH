...
extern void ChannelEst_api(const mxArray * const prhs[6], int32_T nlhs, const
  mxArray *plhs[1]);
extern void PBCH_Decode(creal_T sym[240], creal_T chanEst[960], struct0_T *enb,
  creal_T bits[480], creal_T symbols[240], real_T *nfmod4, real_T trblk[24],
  real_T *cellrefp);
extern void PBCH_Decode_api(const mxArray * const prhs[3], int32_T nlhs, const
  mxArray *plhs[5]);
