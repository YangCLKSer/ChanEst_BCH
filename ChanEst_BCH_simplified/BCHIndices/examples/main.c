...
static void argInit_1x240_creal_T(creal_T result[240]);
static void argInit_1x3_char_T(char result[3]);
static void argInit_1x4x240_creal_T(creal_T result[960]);
...
static void main_PBCH_Decode(void);

/* Function Definitions */

/*
 * Arguments    : creal_T result[240]
 * Return Type  : void
 */
static void argInit_1x240_creal_T(creal_T result[240])
{
...
static void argInit_1x4x240_creal_T(creal_T result[960])
{
  ...
  for (idx1 = 0; idx1 < 4; idx1++) {
    for (idx2 = 0; idx2 < 240; idx2++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result[idx1 + (idx2 << 2)] = argInit_creal_T();
    }
  }
}
...
static void main_PBCH_Decode(void)
{
  ...
  /* Initialize function 'PBCH_Decode' input arguments. */
  /* Initialize function input argument 'sym'. */
  /* Initialize function input argument 'chanEst'. */
  /* Initialize function input argument 'enb'. */
  /* Call the entry-point 'PBCH_Decode'. */
  argInit_1x240_creal_T(dcv);
  argInit_1x4x240_creal_T(dcv1);
  argInit_struct0_T(&r);
  PBCH_Decode(dcv, dcv1, &r, bits, symbols, &nfmod4, trblk, &cellrefp);
}
