...
static void b_mld2sfbc(const FLOAT_TYPE Received[120], const FLOAT_TYPE mimoCH[240],
  FLOAT_TYPE Detected[120], FLOAT_TYPE ampd[120])
{
  ...
  /*  */
  memset(&Detected[0], 0, 120U * sizeof(FLOAT_TYPE));
                     ...
                     FLOAT_TYPE Detected[240], FLOAT_TYPE ampd[240])
{
  ...
  memset(&Detected[0], 0, 240U * sizeof(FLOAT_TYPE));
...
{
  int i;
  FLOAT_TYPE tmpRec[120];
  FLOAT_TYPE temp_mimoCH[240];
  FLOAT_TYPE tmpDetd1[120];
  FLOAT_TYPE ampd1[120];
  int tmpRec_tmp;
  int b_tmpRec_tmp;
  FLOAT_TYPE tmpDetd2[120];
  FLOAT_TYPE ampd2[120];
  int c_tmpRec_tmp;
  int temp_mimoCH_tmp;
...
void mrc(struct_complex Detected_RB[240],FLOAT_TYPE ampd[240], const struct_complex RxData[240], const struct_complex equCH[960])
{
    FLOAT_TYPE im,re;
    int i_strm;
...
void MIMO_detectRB(struct_complex Detected_RB[240], FLOAT_TYPE ampd[240], const struct_complex RxData[240], 
    const struct_complex equCH[960], int methodDetect)
{
    FLOAT_TYPE b_Detected_RB[240];
    int i_strm;
    int re_tmp;
    FLOAT_TYPE im;
    FLOAT_TYPE re;
